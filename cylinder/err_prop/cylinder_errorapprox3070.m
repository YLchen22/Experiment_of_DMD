% ---divide dataset differently and perform better---
...
recon_half = recon(:, 1:70);   % corresponding to time 31:100
recon2 = recon(:, 71:121);     % corresponding to time 101:151
bias2 = valid_data - recon2;

% DMD to approximate error propagation
error = data(:, 31:100) - recon_half;
X = error(:, 1:69); Y = error(:, 2:70);
step_min = 1; step_max = 51;
[recon, ~] = dmd_predict(X, Y, r, step_min, step_max);
...
steps = 51;
file_name = ['Cylinder_errorapprox', num2str(r), 'rank3070.gif'];
