...
data = data + noise_scale * randn(size(data));
...
% view_data(data, nx, ny, tr, data_name)
...
% view_mode(data_name, 1, 0.1)
% % view_mode(data_name, 2, 0.1)
% view_mode(data_name, 3, 0.1)

view_pred([data_name, '_dmd.mat'], steps, true, [data_name, '_dmd'])
view_pred([data_name, '.mat'], steps, true, [data_name, '_online'])

% view_pred([data_name, '_dmd.mat'], steps, false, [data_name, '_dmd_forward'])
% view_pred([data_name, '.mat'], steps, false, [data_name, '_online_forward'])
view_modes4([data_name, '.mat'], [data_name, '_top_modes'])
