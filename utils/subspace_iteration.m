function [record_evals, record_vr, record_P, record_B] = subspace_iteration(data, r, init, steps)
...
for i = init: steps
    ...
    alpha = 1;
    vecs_new = alpha*(Dt * BU_new) + (1-alpha)*P*vr;
    ...
    % Dt_proj = P_new' * X; % use w columns
    Dt_proj = P_new' * P_new * P_new' * X; % use w columns
